...
def load_links():
    with open("Leetcode-Scraping/Qdata/Qindex.txt") as f:
        link=f.readlines()
    return link

def load_headings():
    my_enc=find_encoding("Leetcode-Scraping/Qdata/index.txt")
    with open("Leetcode-Scraping/Qdata/index.txt",encoding=my_enc) as f:
       head=f.readlines()
    return head
